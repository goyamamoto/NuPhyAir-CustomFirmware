<!-- The README of upstream smk (carlossless/smk), kept for reference; its links are adjusted to this folder. -->
...
Platform notes: [SH68F90 / SH68F90A](platforms/sh68f90.md), [SH68F881](platforms/sh68f881.md), [SH68F89](platforms/sh68f89.md).
...
Currently, this project is primarily developed with the help of [Nix](https://nixos.org/) and Nix flakes. Please consider using Nix and the provided [flake](../flake.nix) to automatically set up a reproducible development environment.
