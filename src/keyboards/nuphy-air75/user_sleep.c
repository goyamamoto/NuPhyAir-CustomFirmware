...
static void park_panel(void)
{
    ...
    GPIO_PULLUP_OFF(0, RGB_R3R_P0_2 | RGB_R1B_P0_3 | RGB_R1R_P0_4);
    GPIO_OUTPUT(0, RGB_R3R_P0_2 | RGB_R1B_P0_3 | RGB_R1R_P0_4);
    GPIO_LOW(0, RGB_R3R_P0_2 | RGB_R1B_P0_3 | RGB_R1R_P0_4);

    GPIO_PULLUP_OFF(5, RGB_R3B_P5_7);
    GPIO_OUTPUT(5, OS_MODE_SWITCH_P5_6 | RGB_R3B_P5_7);
    GPIO_LOW(5, OS_MODE_SWITCH_P5_6 | RGB_R3B_P5_7);

    GPIO_PULLUP_OFF(6, RGB_R0G_P6_0 | RGB_R1G_P6_1 | RGB_R2G_P6_2 | RGB_R3G_P6_3 | RGB_R4G_P6_4 | RGB_R5G_P6_5 | RGB_R2B_P6_6 | RGB_R2R_P6_7);
    GPIO_OUTPUT(6, RGB_R0G_P6_0 | RGB_R1G_P6_1 | RGB_R2G_P6_2 | RGB_R3G_P6_3 | RGB_R4G_P6_4 | RGB_R5G_P6_5 | RGB_R2B_P6_6 | RGB_R2R_P6_7);
    GPIO_LOW(6, RGB_R0G_P6_0 | RGB_R1G_P6_1 | RGB_R2G_P6_2 | RGB_R3G_P6_3 | RGB_R4G_P6_4 | RGB_R5G_P6_5 | RGB_R2B_P6_6 | RGB_R2R_P6_7);

    GPIO_PULLUP_OFF(4, RGB_R0B_P4_0 | RGB_R0R_P4_1 | RGB_R5B_P4_3 | RGB_R5R_P4_4 | RGB_R4R_P4_5 | RGB_R4B_P4_6);
    GPIO_OUTPUT(4, RGB_R0B_P4_0 | RGB_R0R_P4_1 | RGB_R5B_P4_3 | RGB_R5R_P4_4 | RGB_R4R_P4_5 | RGB_R4B_P4_6);
    GPIO_LOW(4, RGB_R0B_P4_0 | RGB_R0R_P4_1 | RGB_R5B_P4_3 | RGB_R5R_P4_4 | RGB_R4R_P4_5 | RGB_R4B_P4_6);
    ...
    // Air75 only: both stock sleep paths drive P7.6 low, and the USB-suspend path
    // also latches P7.7 high.
    PWR_AUX_OUT = 0;
    P7_7        = 1;
}
