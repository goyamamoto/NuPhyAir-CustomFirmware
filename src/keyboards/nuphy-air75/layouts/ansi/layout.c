...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |---------------------------------------------------------------|
     * |Ctl|Opt|Cmd|          Space          |Cmd| Fn|Ctl|Lef|Dow|Rig|
     * `---------------------------------------------------------------'
     */
    [_MAC_BL] = LAYOUT_75(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                    KC_RGUI, FN_MAC,  KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_MAC_FL] = LAYOUT_75(
        ...
        _______, LNK_BT1, LNK_BT2, LNK_BT3, LNK_24G, _______, _______, _______, _______, _______, _______, BAT_FL,  BAT_ON,  BAT_OFF,          _______,
